...
<div class="main" style="text-align:center; margin-top:60px;">
    ...
    <div style="margin-top:30px; display:flex; justify-content:center; gap:16px;">
        ...
        <a href="<?php echo e(route('orders.index')); ?>" class="btn btn-secondary">Ver meus pedidos</a>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mini-erp-laravel\resources\views/orders/success.blade.php ENDPATH**/ ?>